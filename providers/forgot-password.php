...
if($_SERVER["REQUEST_METHOD"]== "POST" && isset($_POST['email']) && !empty($_POST['email']))
{
    ...
    if($stmt->fetchColumn() >0)
    {
        ...
        mail($email,'Reset Password : http://water.coolpage.biz/providers/reset-password.php?email=','Password Reset Link :
        http://water.coolpage.biz/providers/reset-password.php?email='.$email.'&key='.$key,$headers);
