...
function signupO()
{
    $var=array('name','email','phone','password','address','state','city','pincode','customerid','meternumber','zone','ward');
    $a=array(null);
    foreach($var as $v)
    {
    ...
    $stmt=execSQL('SELECT status FROM customers WHERE email=?',array($email));
    ...
    mail($email,'Confirmation Email : WCDS','If You have Signed Up for WCDS please verify you account by going to following link:<br><br>
'.$p.'/organisers/verifyemail.php?email='.$email.'&key='.$key.'
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="POST">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" name="customerid" class="form-control form-control-user" id="customerid" placeholder="Customer Id">
                  </div>
                  <div class="col-sm-6">
                    <input type="text" name="meternumber" class="form-control form-control-user" id="meternumber" placeholder="Meter Number">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
